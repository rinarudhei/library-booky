...
export const PopularAuthorCard = ({
  ...
  return (
    <Card
      className={clsx(
        'flex flex-row items-center justify-start gap-3 rounded-xl bg-white p-3 shadow-xs hover:bg-neutral-100 sm:max-w-full sm:gap-4 sm:p-4'
      )}
    >
      <Link
        href={{ pathname: '/author', query: { authorId } }}
        className='flex flex-row items-center justify-start gap-3 overflow-x-hidden'
      >
